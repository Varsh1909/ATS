...
//     try {
//       const response = await fetch('http://localhost:3001/rank-candidates', {
//         method: 'POST',
//         headers: {
...
//                       <th scope="col" className="sticky top-0 z-10 bg-gray-50 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Work Authorization</th>
//                       <th scope="col" className="sticky top-0 z-10 bg-gray-50 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">City</th>
//                       <th scope="col" className="sticky top-0 z-10 bg-gray-50 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">State</th>
//                       <th scope="col" className="sticky top-0 z-10 bg-gray-50 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Willing to Relocate</th>
...
//                           </span>
//                         </td>
//                         <td className="px-6 py-4 whitespace-normal text-sm text-gray-500 max-w-xs">{candidate.work_authorization}</td>
//                         <td className="px-6 py-4 whitespace-normal text-sm text-gray-500 max-w-xs">{candidate.city}</td>
//                         <td className="px-6 py-4 whitespace-normal text-sm text-gray-500 max-w-xs">{candidate.state}</td>
//                         <td className="px-6 py-4 whitespace-normal text-sm text-gray-500 max-w-xs">{candidate.willing_to_relocate}</td>
//                       </tr>
//                     ))}
//                   </tbody>
//                 </table>
